...
$username = isset($_REQUEST['geoNameUsername']) ? htmlspecialchars($_REQUEST['geoNameUsername']) : '';

$url = "http://api.geonames.org/countryInfoJSON?country=$countryIso_a2&username=$username";
